...
const persons = [
  ...
  function findAdults(liste) {

    let array = []
    let femme = liste.filter(function(a){
      return a.age >= 18 && a.sex == "female";
    })
    let homme = liste.filter(function(b){
      return b.age >= 18 && b.sex == "male";
    } )
    array.push(femme, homme);
    return array
